...
urlpatterns = [
    ...
    path('product-categories/<int:pk>/', views.CategoryDetailView.as_view(), name='category-detail'),
    path('product-taxcodes/', views.TaxCodeListView.as_view(), name='tax-code-list'),
    path('product-taxcodes/<int:pk>/', views.TaxCodeDetailView.as_view(), name='tax-code-detail'),
    path('product-uoms/', views.UOMListView.as_view(), name='uom-list'),
    path('product-uoms/<int:pk>/', views.UOMDetailView.as_view(), name='uom-detail'),
    path('product-warehouses/', views.WarehouseListView.as_view(), name='warehouse-list'),
    path('product-warehouses/<int:pk>/', views.WarehouseDetailView.as_view(), name='warehouse-detail'),
    path('product-sizes/', views.SizeListView.as_view(), name='size-list'),
    path('product-sizes/<int:pk>/', views.SizeDetailView.as_view(), name='size-detail'),
    path('product-colors/', views.ColorListView.as_view(), name='color-list'),
    path('product-colors/<int:pk>/', views.ColorDetailView.as_view(), name='color-detail'),
    path('product-suppliers/', views.ProductSupplierListView.as_view(), name='supplier-list'),
    path('product-suppliers/<int:pk>/', views.ProductSupplierDetailView.as_view(), name='supplier-detail'),
